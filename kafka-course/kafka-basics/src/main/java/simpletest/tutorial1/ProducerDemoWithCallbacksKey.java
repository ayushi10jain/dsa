...
public class ProducerDemoWithCallbacksKey {
    public static void main(String[] args) {
        // create logger
        Logger logger = LoggerFactory.getLogger(ProducerDemoWithCallbacksKey.class);
        ...
        for (int i = 0; i < 10; i++) {
            ...
            //same key will always goes to the same partitions
